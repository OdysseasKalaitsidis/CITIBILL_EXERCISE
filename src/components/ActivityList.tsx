...
export default function ActivityList({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex overflow-x-auto flex-nowrap gap-2 pb-2 -mx-4 px-4 sm:mx-0 sm:px-0 sm:flex-wrap scrollbar-none [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
        <button
          type="button"
